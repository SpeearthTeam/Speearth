...
CREATE TABLE Biglietto (Fornitore varchar(255) NOT NULL, Partenza varchar(255) NOT NULL, Destinazione varchar(255) NOT NULL, DataPartenzaAndata datetime NOT NULL, DataPartenzaRitorno datetime NOT NULL, DataArrivoAndata datetime NOT NULL, DataArrivoRitorno datetime NOT NULL, NumeroAdulti int(11) NOT NULL, NumeroBambini int(11) NOT NULL, Mezzo varchar(255) NOT NULL, ServizioComponentId int(11) NOT NULL, PRIMARY KEY (ServizioComponentId)) engine=InnoDB;
CREATE TABLE Cliente (Id int(11) NOT NULL AUTO_INCREMENT, Nome varchar(255) NOT NULL, Cognome varchar(255) NOT NULL, DataNascita date NOT NULL, CodiceFiscale varchar(255) NOT NULL, CodiceTessera int(11) NOT NULL, PRIMARY KEY (Id)) engine=InnoDB;
